...
<%@page
	import="javax.servlet.http.*,com.prem.interview.pojo.*,com.prem.interview.rpc.*"%>
<html>
<head>
...
<body>
	...
	<font size="3">=======================================================================<br><%="list of categories".toUpperCase()%>
		...
		<div id="textSectionListOfCategories">
			...
			<ul>
				...
				<li><a id="<%="cats_" + cats.getCatID()%>"
					href="<%="#" + cats.getCatID()%>"><%=(catCounter++) + " . "
							+ cats.getCatgoryName().toUpperCase()%> </a>
					<div class="guess_box">
 ...
 %>
	...
	<span><a href="<%="#cats_" + cats.getCatID()%>"> <img
			src="images/up_to_summary.png" width="15" height="25" /></a> </span>
	...
	<div class="guess_box_ques">
		...
		<div>
			...
			<br />********** <br /> <font size="3" style="font-weight: bold"
				color="red"> <a
				id="<%=cats.getCatID() + "_" + q.getQuestionID()%>"> <%=" QUESTION : " + (count++) + "<br>"
								+ q.getQuestion()%></a></font> <span><a
				href="<%="#ques_" + cats.getCatID() + "_"
								+ q.getQuestionID()%>">
					<img src="images/up_to_summary.png" width="15" height="25" />
			</a> </span> <br />
			...
			<div class="guess_box_ques_ans">
				...
				<div>
					...
					%>
					<br /> <font size="3" style="font-weight: bold" color="green">
						<%="{ ANSWER : " + (answerNo++) + " }"%>
					</font> <br /> <font size="3" style="font-weight: bold"> <%=ans.getAnswer()%>
					</font>
